...
int main()
{
    ...
    vector<int> v3(4, 3);   // 초기화, 크기 4로 모두 3으로 채워라
    ...
    vec[2] = 10;    // 인덱스 2번 원소 변경     // 시간복잡도 : O(1)
    for (int value : vec) {
        cout << value << ". ";
    }
    cout << endl;
	...
	cout << "Rabbit's Score: " << score2 << endl;   // 0. 가능한가? 실제 값이 0이면?
    // ※ 위 처럼 하면 Rabnit 키를 자동 생성해서 0을 추가
