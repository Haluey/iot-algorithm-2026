...
void modifyByValue(int value) {
    ...
    cout << "2. 주소 : " << &value << endl;   // 00000077D80FF870
...
void modifyByReference(int& value) {
    ...
    cout << "4. 주소 : " << &value << endl;   // 00000077D80FF894
...
int main()
{
    ...
    int value = 5;
    cout << "1. 주소 : " << &value << endl;   // 00000077D80FF894
    cout << "1. 값 : " << value << endl;     // 5

    modifyByValue(value);  // 함수 호출
    cout << "3. 주소 : " << &value << endl;   // 00000077D80FF894
    cout << "3. 값 : " << value << endl;    // 5

    modifyByReference(value);
    cout << "5. 주소 : " << &value << endl;   // 00000077D80FF894
    cout << "5. 값 : " << value << endl;    // 15

    // 2. auto문 -> javascript, C#의 var와 동일
    auto num = 42;  // int로 추론
    cout << num << endl;
